...
function Edit({
  ...
  const userPatterns = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    ...
    return posts.filter(post => {
      var _post$_embedded$wpTe;
      const terms = (_post$_embedded$wpTe = post._embedded?.['wp:term']?.flat()) !== null && _post$_embedded$wpTe !== void 0 ? _post$_embedded$wpTe : [];
      return terms.some(term => term.taxonomy === 'wp_pattern_category' && term.slug === 'mega-menu');
    });
  }, []);

  // Fetch published pages for the active parent page selector.
  const pageOptions = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    ...
    return records.map(page => {
      var _page$title$rendered;
      return {
        label: (_page$title$rendered = page.title?.rendered) !== null && _page$title$rendered !== void 0 ? _page$title$rendered : page.slug,
        value: page.id
      };
    });
  }, []);
  ...
  const postTypeOptions = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    const types = select('core').getPostTypes({
      per_page: -1
    });
    if (!types) return [];
    const excluded = ['attachment', 'wp_block', 'wp_navigation', 'wp_template', 'wp_template_part', 'wp_global_styles', 'wp_font_family', 'wp_font_face'];
    return types.filter(type => type.viewable && !excluded.includes(type.slug)).map(type => ({
      label: type.name,
      value: type.slug
    }));
  }, []);
  ...
  const noMenusNotice = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Notice, {
    status: "warning",
    isDismissible: false
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.createInterpolateElement)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No Patterns could be found. Create a new one in the <a>Site Editor</a>.', 'mega-menu-block'), {
  ...
  const menuDoesntExistNotice = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Notice, {
    status: "warning",
    isDismissible: false
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('The selected Pattern no longer exists. Choose another.', 'mega-menu-block'));
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Mega Menu Pattern', 'mega-menu-block'),
    value: menuSlug,
    options: menuOptions,
    onChange: value => setAttributes({
      menuSlug: value
    }),
    help: hasMenus && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.createInterpolateElement)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Create and modify Patterns in the <a>Site Editor</a>.', 'mega-menu-block'), {
      a: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        // eslint-disable-line
        href: menuPatternUrl,
        target: "_blank",
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Disable mega menu in overlay', 'mega-menu-block'),
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('When the navigation is displayed in an overlay, typically on mobile devices, disable the mega menu.', 'mega-menu-block')
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('When the mega menu is disabled in the overlay, link to this URL instead.', 'mega-menu-block'),
    autoComplete: "off"
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Active State', 'mega-menu-block'),
    initialOpen: false
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.__experimentalVStack, {
    spacing: 4
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ComboboxControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Active for parent page', 'mega-menu-block'),
    value: activeParentPage || null,
    options: pageOptions,
    onChange: value => setAttributes({
      activeParentPage: value !== null && value !== void 0 ? value : 0
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ComboboxControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Active for post type', 'mega-menu-block'),
    value: activePostType || null,
    options: postTypeOptions,
    onChange: value => setAttributes({
      activePostType: value !== null && value !== void 0 ? value : ''
    })
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Mode', 'mega-menu-block'),
    initialOpen: false
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Show chevron', 'mega-menu-block'),
    checked: showChevron,
    ...
    allowedFormats: ['core/bold', 'core/italic', 'core/image', 'core/strikethrough', 'core/superscript', 'core/subscript']
  }), showChevron && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
